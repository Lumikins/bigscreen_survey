    ...
    <div class="w-full h-full">
        <dh-component>
            <div class="flex flex-no-wrap">
                <!-- Sidebar starts -->
                <div
                    class="w-64 absolute sm:relative bg-gray-800 shadow md:h-full flex-col justify-between flex min-h-[716px]">
                    <div class="px-8">
                        <div class="h-16 w-full flex items-center">
                            <img class="mx-auto h-12 w-auto"
                                src="https://www.bigscreenvr.com/images/logos/bigscreen.svg" alt="Bigscreen">
                        </div>
                        <ul class="mt-12">
                            <li
                            ...
                            <form action="/logout" method="POST">
                                ...
                                <li
                                    ...
                                    <button type="submit"
                                        class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-tabler icon-tabler-logout" width="18" height="18"
                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                            <path
                ...
                <div class="container mx-auto py-10 md:w-4/5 w-11/12">
