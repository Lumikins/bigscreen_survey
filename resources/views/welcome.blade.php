					...
					<div class="relative px-6 lg:px-8">
						<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-10">
							...
							<div class="text-center">
								<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Bigscreen<br>
										Votre salon de réalité virtuelle
										</h1>
								<p class="mt-6 text-lg leading-8 text-gray-600">Bigscreen est un lieu où l'on peut se retrouver entre amis, collaborer avec des collègues, jouer à des jeux, regarder des films, et bien plus encore.
								</p>
								<p class="mt-2 text-lg leading-8 text-gray-600">Nous essayons toujours de nous améliorer et nous avons besoin de votre aide pour y parvenir.
								</p>
