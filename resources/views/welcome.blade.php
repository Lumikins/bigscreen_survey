					...
					<div class="relative px-6 lg:px-8">
						<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-10">
							...
							<div class="text-center">
								...
								<p class="mt-6 text-lg leading-8 text-slate-200">Bigscreen est un lieu où l'on peut se retrouver entre amis, collaborer avec des collègues, jouer à des jeux, regarder des films, et bien plus encore.
								</p>
